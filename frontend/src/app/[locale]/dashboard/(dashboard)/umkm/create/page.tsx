...
export default function CreateUmkmPage() {
  ...
  const { create } = useResourceMutations(umkmConfig.endpoint, umkmConfig.labelSingular);
  ...
  return (
    <div className="max-w-4xl pb-16">
      <div className="mb-6 flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-ink">Tambah {umkmConfig.labelSingular}</h1>
          <p className="text-sm text-ink-soft">Buat entri {umkmConfig.labelSingular.toLowerCase()} baru</p>
        </div>
      </div>
