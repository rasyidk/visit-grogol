...
export default function CreateWisataPage() {
  ...
  const { create } = useResourceMutations(wisataConfig.endpoint, wisataConfig.labelSingular);
  ...
  return (
    <div className="max-w-4xl pb-16">
      <div className="mb-6 flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-ink">Tambah {wisataConfig.labelSingular}</h1>
          <p className="text-sm text-ink-soft">Buat entri {wisataConfig.labelSingular.toLowerCase()} baru</p>
        </div>
      </div>
