...
export default function CreateKulinerPage() {
  ...
  const { create } = useResourceMutations(kulinerConfig.endpoint, kulinerConfig.labelSingular);
    ...
    <div className="max-w-4xl pb-16">
      <div className="mb-6 flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-ink-soft">Buat entri {kulinerConfig.labelSingular.toLowerCase()} baru</p>
        </div>
      </div>
