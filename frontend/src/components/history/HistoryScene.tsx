            ...
            <div className="w-full h-full flex items-center px-6 lg:px-24">
              <div className="max-w-2xl">
                <motion.div 
                  ...
                  className="font-display font-black text-[15vw] lg:text-[12rem] tracking-tighter leading-none text-[#d3dfd6] mb-4"
                >
                  1916
                </motion.div>
            ...
            <div className="w-full h-full flex items-center justify-end px-6 lg:px-32">
              <div className="max-w-2xl text-right">
                <motion.div 
                  ...
                  className="font-display font-black text-7xl lg:text-9xl tracking-tighter text-[#d3dfd6] mb-6"
                >
                  1927
                </motion.div>
            ...
            <div className="w-full h-full flex flex-col lg:flex-row items-center justify-between px-6 lg:px-24 pt-24 pb-32">
              <div className="flex-1 lg:pr-12 w-full">
                <motion.div 
                  ...
                  className="font-display font-black text-[12vw] lg:text-[10rem] tracking-tighter leading-[0.8] text-[#d3dfd6] mb-4"
                >
                  1965
                </motion.div>
          ...
          <SceneWrapper key="state-6">
            <div className="w-full h-full flex flex-col justify-center px-6 lg:px-32">
              <div className="max-w-3xl ml-auto text-right">
                <div className="font-display font-black text-5xl lg:text-7xl tracking-tighter text-[#d3dfd6] mb-2">1996 — 2014</div>
