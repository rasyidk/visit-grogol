...
export const beritaConfig: ResourceConfig = {
  ...
  description: 'Kelola artikel Kabar Grogol.',
  formMode: 'page',
  searchable: true,
  filters: [boolFilter('Publikasi', 'is_active')],
  sortOptions: [
    { label: 'Terbaru', value: 'createdAt' },
    { label: 'Judul', value: 'title' },
  ],
  ...
  fields: [
    ...
    { name: 'author', label: 'Penulis', type: 'text', colSpan: 2 },
    { name: 'thumbnail', label: 'Gambar Cover', type: 'image', help: 'URL Gambar Thumbnail', colSpan: 2 },
...
export const budayaConfig: ResourceConfig = {
  key: 'budaya',
  endpoint: '/budaya',
  label: 'Manajemen Budaya',
  labelSingular: 'Budaya',
  description: 'Kelola konten halaman Budaya Publik (Bilingual).',
  formMode: 'page',
  searchable: true,
  filters: [boolFilter('Aktif', 'is_active')],
  sortOptions: [
  ...
  fields: [
    ...
    { name: 'titleEn', label: 'Judul (Bahasa Inggris)', type: 'text', required: false, colSpan: 1 },
    { name: 'thumbnail', label: 'Thumbnail Utama', type: 'image', help: 'URL Gambar Thumbnail', colSpan: 2 },
    { name: 'images', label: 'Galeri Foto', type: 'gallery', help: 'Beberapa foto untuk carousel budaya', colSpan: 2 },
    { name: 'content', label: 'Konten (Bahasa Indonesia)', type: 'richtext', colSpan: 2 },
    { name: 'contentEn', label: 'Konten (Bahasa Inggris)', type: 'richtext', colSpan: 2 },
    { name: 'isActive', label: 'Tampilkan ke Publik', type: 'switch', defaultValue: true },
    { name: 'isGalleryActive', label: 'Aktifkan Galeri Foto', type: 'switch', defaultValue: true },
...
export const homestayConfig: ResourceConfig = {
  ...
  fields: [
    ...
    { name: 'facilities', label: 'Fasilitas (pisahkan dengan koma)', type: 'text', colSpan: 2 },
    { name: 'thumbnail', label: 'Thumbnail Utama', type: 'image', colSpan: 2 },
    { name: 'is_gallery_active', label: 'Tampilkan Slider Galeri di Halaman Detail', type: 'switch', defaultValue: true, colSpan: 2 },
    { name: 'images', label: 'Galeri Tambahan', type: 'gallery', colSpan: 2 },
    { name: 'is_active', label: 'Status Publikasi (Aktif)', type: 'switch', defaultValue: true, colSpan: 2 },
