...
export const destinasiConfig: ResourceConfig = {
  ...
  fields: [
    { name: 'title', label: 'Judul', type: 'text', required: true, colSpan: 2 },
    ...
    { name: 'excerpt', label: 'Ringkasan', type: 'text', colSpan: 2 },
    { name: 'description', label: 'Deskripsi', type: 'textarea', required: true, colSpan: 2 },
    ...
    { name: 'facilities', label: 'Fasilitas', type: 'tags', placeholder: 'WIFI, Parkir, AC', colSpan: 2 },
...
export const kategoriConfig: ResourceConfig = {
  ...
  fields: [
    { name: 'name', label: 'Nama Kategori', type: 'text', required: true, colSpan: 1 },
...
export const bannerConfig: ResourceConfig = {
  ...
  fields: [
    { name: 'title', label: 'Judul', type: 'text', required: true, colSpan: 2 },
    { name: 'subtitle', label: 'Subjudul', type: 'text', colSpan: 2 },
    { name: 'image', label: 'Gambar Banner', type: 'image', required: true, colSpan: 2 },
    { name: 'ctaLabel', label: 'Teks Tombol', type: 'text', colSpan: 1 },
    { name: 'link', label: 'Link Tombol', type: 'text', colSpan: 1 },
...
export const beritaConfig: ResourceConfig = {
  ...
  fields: [
    ...
    { name: 'content', label: 'Konten', type: 'textarea', required: true, colSpan: 2 },
...
export const eventConfig: ResourceConfig = {
  ...
  fields: [
    ...
    { name: 'description', label: 'Deskripsi', type: 'textarea', required: true, colSpan: 2 },
    { name: 'content', label: 'Konten Lengkap', type: 'textarea', colSpan: 2 },
    { name: 'thumbnail', label: 'Gambar', type: 'image', required: true, colSpan: 2 },
    { name: 'isPublished', label: 'Publikasikan', type: 'switch', defaultValue: true },
  ],
};
...
export const galeriFotoConfig: ResourceConfig = {
  ...
  fields: [
    { name: 'title', label: 'Judul', type: 'text', required: true, colSpan: 1 },
    { name: 'category', label: 'Kategori', type: 'text', colSpan: 1 },
...
export const testimoniConfig: ResourceConfig = {
  ...
  fields: [
    ...
    { name: 'role', label: 'Peran/Profesi', type: 'text', colSpan: 1 },
    { name: 'origin', label: 'Asal', type: 'text', colSpan: 1 },
    { name: 'rating', label: 'Rating (1-5)', type: 'number', min: 1, max: 5, defaultValue: 5, colSpan: 1 },
    { name: 'avatar', label: 'Foto', type: 'image', colSpan: 2 },
    { name: 'message', label: 'Pesan', type: 'textarea', required: true, colSpan: 2 },
